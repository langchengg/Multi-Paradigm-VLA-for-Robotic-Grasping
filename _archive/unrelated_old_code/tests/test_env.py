...
def fake_mujoco_renderer(monkeypatch):
    """Keep legacy env tests independent of local macOS OpenGL availability."""
    from envs import simple_grasp_env as simple_module
